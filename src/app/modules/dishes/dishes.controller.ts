...
export class DishesController {
    ...
    register(express: Application) { 
        ...
        express.use('/api/v1/dishes', guard, this.router) 
    }
    ...
    init() {
        ...
        this.router.post("/saveImage", Upload.uploadFile('/uploads').single('file'),TryCatch.tryCatchGlobe(this.saveImage))
    ...
    async index(req: Request, res: Response): Promise<void> {        
        ...
        const {data, page}: any = await new DishesRepository().index(req.query as any)
    ...
    async findById(req: Request, res: Response): Promise<void> {
        ...
        const data = await new DishesRepository().findById(id)
    ...
    async create(req: Request, res: Response){        
        ...
        const data = await new DishesRepository().create(body, mongoSession)
    ...
    async update(req: Request, res: Response){
        ...
        const data = await new DishesRepository().update(body, mongoSession)
    ...
    async saveImage(req: Request, res: Response){
        res.locals = {status: false, message: Messages.CREATE_FAILED};
        // const data = await JtSaveImage({image: req.body.image, fileName: req.body.fileName, path: 'images/uploads'})
