...
class DishesBusiness {
    private _dishesRepository: DishesRepository;

    constructor() {
        this._dishesRepository = new DishesRepository();
    }
...
Object.seal(DishesBusiness);
export = DishesBusiness;
