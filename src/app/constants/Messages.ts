export class Messages {
    ...
    static readonly CLOSED_BUSINESS_FAILED_WITH_STONES_MISSING: string = "closed Business failed with stones missing"
    static readonly CLOSED_BUSINESS_FAILED_DIAMOND_MATCH: string = "closed Business failed for diamond match not performed"
